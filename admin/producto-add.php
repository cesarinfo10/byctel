...
if (isset($_POST["agregar"])) {
  $insertSQL ="INSERT INTO producto (Titulo, DescripcionCorta, Precio, Activo) VALUES ('$_POST[Titulo]', '$_POST[DescripcionCorta]', '$_POST[Precio]', '$_POST[Activo]')";
...
?>
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1><!-- InstanceBeginEditable name="Titulo" -->Agregar Producto<!-- InstanceEndEditable --></h1>
...
<br/>
     ...
     <tr valign="baseline">
       ...
       <td><input name="Precio" type="text" class="campo" value="" size="32" /></td>
     </tr>
     <tr valign="baseline">
        <tr valign="baseline">
