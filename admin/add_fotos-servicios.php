...
$sql="SELECT idServicios FROM servicios ORDER BY idServicios DESC";
$query=mysql_query($sql, $conexion) or die(mysql_error());
$row=mysql_fetch_assoc($query);
$totalRow=mysql_num_rows($query);
$n=  $row["idServicios"];
mysql_select_db($database_conexion, $conexion);
$query_agregarfoto = "SELECT * FROM fotosser WHERE idServicios='$n'";
...
function validarForm(formulario) {
 ...
 window.location = 'add_fotos-servicios.php';
}
...
<td align="rigth"><input type="text" id="idServicios" onclick="javascript:validarForm()" name="idServicios" value="<?php echo $row['idServicios']; ?>"> </td>
   </tr>
     <tr valign="baseline">
