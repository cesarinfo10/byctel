...
$query_agregarfoto = "SELECT * FROM fotos WHERE idProducto='$varFoto'";
...
<td align="rigth"><input type="text" id="idProducto" onclick="javascript:validarForm()" name="idProducto" value="<?php echo $varFoto ?>"> </td>
   </tr>
     <tr valign="baseline">
...
do { ?>
    ...
    <a href="edit_foto.php?VarFo=<?php echo $row_agregarfoto['IdFoto']; ?>&varLink=<?php echo $varFoto ?>"><img src="../images/iconos/editar.png" alt="" width="27" height="27" /></a>
    <a href="producto-estado.php?varFoto=<?php echo $row_agregarfoto['IdFoto']; ?>&portFoto=portFoto&varLink=<?php echo $varFoto ?>"><img src="../images/iconos/borrar.png" alt="" width="27" height="27" /></a>
    <div class="radio">
<a href="fotoperfil-editar.php?VarFoper=<?php echo $row_agregarfoto['IdFoto']; ?>&Varprop=<?php echo $row_agregarfoto['idProducto']; ?>"><img src="../images/iconos/perfil.png"></a>
    </div>
